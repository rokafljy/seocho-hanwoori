...
> 이 파일은 다른 컴퓨터(노트북 등)에서 작업을 이어갈 때 Codex가 현재 상태를 빠르게 파악하기 위한 핸드오프 문서입니다.
...
```
→ http://localhost:4321 (Codex의 Launch preview 패널로도 가능)
...
- 후원계좌 우리은행 1005-901-571747(서초구립한우리정보문화센터), 문의 070-7209-2932·2931.
